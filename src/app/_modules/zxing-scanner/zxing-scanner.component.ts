...
import { Result, BrowserBarcodeReader } from '@zxing/library';

import { BrowserQRCodeReader } from './browser-qr-code-reader';
import { BrowserBarCodeReader } from './browser-barcode-reader';
import { BrowserEAN13Reader } from './browser-ean13-reader';
...
export class ZXingScannerComponent implements AfterViewInit, OnDestroy, OnChanges {
     ...
     */
    constructor() {
        this.codeReader = new BrowserEAN13Reader();
    ...
    public getCodeReader() {
      return this.codeReader;
    }

    public setCodeReader(codeReader: any) {
